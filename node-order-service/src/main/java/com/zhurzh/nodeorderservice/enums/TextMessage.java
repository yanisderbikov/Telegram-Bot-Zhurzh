...
public enum TextMessage {
    ...
    PRICE_INVALID_NUM("I can't understand. Write down just a simple number. It should be more than zero", "Я не очень понял. Напиши пожалуйста просто цифру больше нуля."),
    ...
    FINALIZE_FINAL_ORDER("Your commission is accepted, wait when Zhurzh will contact with you!",
