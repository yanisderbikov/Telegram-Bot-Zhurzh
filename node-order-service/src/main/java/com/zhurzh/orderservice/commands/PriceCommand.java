package com.zhurzh.orderservice.commands;
...
import com.zhurzh.orderservice.controller.HasUserState;
import com.zhurzh.orderservice.controller.UserState;
import com.zhurzh.orderservice.enums.TextMessage;
import com.zhurzh.orderservice.service.CommonCommands;
    ...
    private boolean startCommand(AppUser appUser, Update update){
        try {
            if (update.hasCallbackQuery()) {
                ...
                var out = TextMessage.PRICE_PRE.getMessage(appUser.getLanguage()) + cc.findActiveOrder(appUser).calculatePrice()
